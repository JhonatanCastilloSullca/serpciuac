            ...
            <ul class="list-unstyled components mb-5">
                ...
                <a href="#"  class="dropbtn">Registrar</a>
                  <div class="dropdown-content">
                    <a href="administrativo/registrar_administrativo.php">Registrar Personal Administrativo</a>
                    <a href="administrativo/registrar_docente.php">Registrar Docente</a>
              ...
              <div class="dropdown" id="padingbtn1" >
                <a href="#"  class="dropbtn">Cursos</a>
                  <div class="dropdown-content">
                    <a href="director/crear_idioma.php">Crear Idioma</a>
                    <a href="director/crear_curso.php">Crear Curso</a>
...
<li>
              <div class="dropdown" id="padingbtn1" >
                <a href="#" class="dropbtn">Datos</a>
                  <div class="dropdown-content">
                    <a href="administrativo/datosadministrativo.php">Visualizar Datos</a>
...
<!--
        ...
        <!-- Page Content  -->
              ...
              <div id="content" class="p-4 p-md-5 pt-5">
                <h2 class="mb-4">  <?php echo "Bienvenido Personal Administrativo ". $nombreusuario." ".$appaterno." ".$apmaterno; ?> </h2>
