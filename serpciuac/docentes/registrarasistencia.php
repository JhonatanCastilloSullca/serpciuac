          ...
          <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <form class="form-horizontal" id="frmajax"  method ="post" >
                  ...
                  <div class="form-group col-sm-3">
                    <label class="control-label col-sm-20" for="email">Fecha:</label>
                    
              <input type="text" class="control-label selesctcss mb-3" value="<?php echo $fecha ?>" name="fecha" id="fecha"  >                                        
                  </div>
                  ...
                  <div class="form-group col-sm-3">
                      ...
                      <div class="form-check">
                        <input class="form-check-input radiosize" type="radio" name="radio1" id="exampleRadios1" value="Temprano" checked>
                        <label class="form-check-label" for="exampleRadios1">
                          Temprano
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input radiosize" type="radio" name="radio1" id="exampleRadios2" value="Tarde">
                        <label class="form-check-label" for="exampleRadios2">
                          Tarde
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input radiosize" type="radio" name="radio1" id="exampleRadios3" value="Falta">
                    ...
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <button type="submit" class="submitform btn btn-default" id="btnguardar">Actualizar</button>
                    </div>
                </form>
                <p id='respa' name='respa' ></p>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $('#btnguardar').click(function(){
      ...
      $.ajax({
        type:"POST",
        url:"../logica/registrarasistencia_logica.php",
        data:datos,
        success:function(r){
          if (r==1) {
