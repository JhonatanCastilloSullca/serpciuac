          ...
          <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <form class="form-horizontal" action="../logica/registrarnotas_logica.php" method = "post" >
                  ...
                  <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="control-label selesctcss mb-3" name="n1">                                        
                  </div>
                  <div class="form-group col-sm-3">
                    <label class="control-label col-sm-20" for="email">Nota 2:</label>
                    <input type="text" class="control-label selesctcss mb-3" name="n2">                                        
                  </div>
                  <div class="form-group col-sm-3">
                    <label class="control-label col-sm-20" for="email">Nota 3:</label>
                    <input type="text" class="control-label selesctcss mb-3" name="n3">                                        
                  </div>
                  <div class="form-group col-sm-3">
                    <label class="control-label col-sm-20" for="email">Nota 4:</label>
                    <input type="text" class="control-label selesctcss mb-3" name="n4">                                        
                  </div>
