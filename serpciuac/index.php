...
<head>
  ...
  <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div class="p-4">
                <h1><a href="index.php" class="logo">Sistema ERP</a></h1>
                <h2 class="h2princ" >Centro de Idiomas UAC</h2>
            <ul class="list-unstyled components mb-5">
              <li>
                <!-- class="active" -->
                <a href="#"><span class="mr-3"></span> Matricula</a>
              </li>
              <li>
                  <a href="#"><span class="mr-3"></span> Asistencia</a>
              </li>
              <li>
        ...
        <!-- Page Content  -->
              <div id="content" class="p-4 p-md-5 pt-5">
                <h2 class="mb-4"> <?php echo $_SESSION['usuario'] ?> </h2>
