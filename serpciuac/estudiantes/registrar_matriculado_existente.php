...
<!--
        ...
        <!-- Page Content  -->
              <div id="content" class="p-4 p-md-5 pt-5">
                ...
                <form class="form-horizontal" method="POST" action="../logica/registrar_matriculado_existente_logica.php">
                ...
                $consulta ="SELECT * FROM grados WHERE Id_Grado = (SELECT Id_Grado FROM matriculados WHERE id_usuario = ".$IdUser.")+1";
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="file" accept="image/x-png,image/gif,image/jpeg" class="form-control" id="inputform" placeholder="Ingrese Nuevo Idioma" name="link_foto_voucher">
                    </div>
                  ...
                  <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="submitform btn btn-default">Registrar Matricula</button>
                    </div>
                  </div>
                </form>
