                ...
                <form class="form-horizontal" method="POST" action="../logica/crear_matricula.php">
                  ...
                  <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                      <a href="registrar_matriculado_existente.php" type="submit" class="btnrealizar submitform btn btn-default">Realizar Matricula Normal</a>
                    </div>
                  </div>
                  <!--
                  <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <a href="registrar_matriculado_nuevo_idioma.php" type="submit" class="btnrealizar submitform btn btn-default">Realizar Matricula en Nuevo Idioma </a>
                    </div>
                  </div>-->
                  <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                      
                      <a href="registrar_matriculado_nuevo.php" type="submit" class="btnrealizar submitform btn btn-default">Realizar Matricula por Primera Vez </a>
                    </div>
                  </div>
                </form>
