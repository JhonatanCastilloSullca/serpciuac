            ...
            <ul class="list-unstyled components mb-5">
                ...
                <a href="#"  class="dropbtn">Registrar</a>
                  <div class="dropdown-content">
                    <a href="director/registrar_administrativo.php">Registrar Personal Administrativo</a>
                    <a href="director/registrar_docente.php">Registrar Docente</a>
              ...
              <div class="dropdown" id="padingbtn1" >
                <a href="#"  class="dropbtn">Cursos</a>
                  <div class="dropdown-content">
                    ...
                    <a href="director/crear_horario.php">Crear Horario</a>
...
<li>
              <div class="dropdown" id="padingbtn1" >
                <a href="#" class="dropbtn">Datos</a>
                  <div class="dropdown-content">
                    <a href="director/datosdirector.php">Visualizar Datos</a>
