            ...
            <ul class="list-unstyled components mb-5">
                ...
                <a href="#"  class="dropbtn">Registrar</a>
                  <div class="dropdown-content">
                    <a href="registrar_administrativo.php">Registrar Personal Administrativo</a>
...
<!--
		...
		<div class="container-login100" style="background-color: #fff">
			<div class="wrap-login100registrar p-l-55 p-r-55 p-t-65 p-b-54">
				<form action="../logica/registrar_administrativo_logica" method="POST" class="login100-form validate-form">
					<span class="login100-form-titleh3space login100-form-title p-b-15">
						Sistema ERP <br> Registro de <br> Personal Administrativo
					</span>
