        ...
        <!-- Page Content  -->
              ...
              <div id="content" class="p-4 p-md-5 pt-5">
                <h2 class="mb-4">  <?php echo "Bienvenido Director ". $nombreusuario." ".$appaterno." ".$apmaterno; ?> </h2>
                 ...
                 <form class="form-horizontal" method="POST" action="../logica/crear_horario_logica.php">
                  <div class="form-group">
                    <label class="control-label col-sm-4" for="email">Ingrese Nombre de Horario:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputform" placeholder="Ingrese Horario con este formato Horario 1 Mañana (07:00 - 10:00)" name="nombrehorario">
                    </div>
                    
                  </div>

                  <div class="form-group">
                    <label class="control-label col-sm-4" for="email">Ingrese Hora de Inicio:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputform" placeholder="Ingrese Hora de Inicio con este formato hh:mm:ss" name="horarioini">
                    </div>
                    <div class="form-group">
                    <label class="control-label col-sm-4" for="email">Ingrese Hora de Finalizacion:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputform" placeholder="Ingrese Hora de Fin con este formato hh:mm:ss" name="horariofin">
                    </div>
                  ...
                  <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="submitform btn btn-default">Crear Horario</button>
                    </div>
                  </div>
